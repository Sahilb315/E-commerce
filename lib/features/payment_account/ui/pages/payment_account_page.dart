import 'package:e_commerce_app/features/payment_account/bloc/payment_bloc.dart';
...
class PaymentAccountPage extends StatelessWidget {
  PaymentAccountPage({super.key});

  final paymentBloc = PaymentAccountBloc();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<PaymentAccountBloc, PaymentAccountState>(
        bloc: paymentBloc,
        ...
        child: Column(
          children: [
            ListTile(
              onTap: () {
                paymentBloc.add(PaymentNavigateToCreditDebitPageAccountEvent());
              },
